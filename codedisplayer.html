...
#menu ul {
 ...
 .code {
 	...
 	-webkit-box-sizing: border-box; /* Support FireFox */
 	-moz-box-sizing: border-box; /*Support Safari */
...
('#js').val() ); /*remove the eval function from Javascript as it can cause security issue for your site! */  
 });
